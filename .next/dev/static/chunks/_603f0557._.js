...
function CartProvider({ children }) {
            ...
            setItems({
                "CartProvider.useCallback[addToCart]": (prev)=>{
                    const existing = prev.find({
                        "CartProvider.useCallback[addToCart].existing": (i)=>i.variantId === item.variantId
                    }["CartProvider.useCallback[addToCart].existing"]);
                    if (existing) {
                        return prev.map({
                            "CartProvider.useCallback[addToCart]": (i)=>i.variantId === item.variantId ? {
                                    ...i,
    ...
    const removeFromCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[removeFromCart]": (variantId)=>{
            setItems({
                "CartProvider.useCallback[removeFromCart]": (prev)=>prev.filter({
                        "CartProvider.useCallback[removeFromCart]": (i)=>i.variantId !== variantId
    ...
    const updateQuantity = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[updateQuantity]": (variantId, quantity)=>{
            if (quantity <= 0) {
                setItems({
                    "CartProvider.useCallback[updateQuantity]": (prev)=>prev.filter({
                            "CartProvider.useCallback[updateQuantity]": (i)=>i.variantId !== variantId
...
function WishlistProvider({ children }) {
    ...
    const toggle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WishlistProvider.useCallback[toggle]": (item)=>{
            setItems({
                "WishlistProvider.useCallback[toggle]": (prev)=>{
                    const exists = prev.find({
                        "WishlistProvider.useCallback[toggle].exists": (i)=>i.productId === item.productId
                    }["WishlistProvider.useCallback[toggle].exists"]);
                    if (exists) return prev.filter({
                        "WishlistProvider.useCallback[toggle]": (i)=>i.productId !== item.productId
    ...
    const isWishlisted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WishlistProvider.useCallback[isWishlisted]": (productId)=>items.some({
                "WishlistProvider.useCallback[isWishlisted]": (i)=>i.productId === productId
            }["WishlistProvider.useCallback[isWishlisted]"])
    }["WishlistProvider.useCallback[isWishlisted]"], [
        items
    ]);
...
_s(WishlistProvider, "GkD00ISzxRTvo8rZ/Gtu7OaPuOg=");
_c = WishlistProvider;
...
function AuthProvider({ children }) {
    ...
    const register = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[register]": async (firstName, lastName, email, password)=>{
...
//# sourceMappingURL=_603f0557._.js.map