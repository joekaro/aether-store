  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex flex-col">
      ...
      <div className="w-full px-6 py-5 border-b border-neutral-200 bg-white flex items-center justify-between">
        ...
        <Link href="/register" className="text-sm font-medium text-neutral-500 hover:text-neutral-900 transition-colors">
          Create account →
        </Link>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <button type="button" onClick={() => setShowPassword(!showPassword)} className="text-xs text-neutral-400 hover:text-neutral-700 transition-colors">
          ...
          <p className="text-center text-sm text-neutral-500 mt-6">
            ...
            <Link href="/register" className="font-semibold text-neutral-900 hover:underline">Create one</Link>
          </p>
        </motion.div>
      </div>
    </div>
